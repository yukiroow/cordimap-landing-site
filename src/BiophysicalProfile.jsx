                ...
                <div className="min-h-screen w-full bg-white text-gray-900 px-8 py-12">
                    ...
                    <section className="mb-16">
                        ...
                        <div className="flex flex-col lg:flex-row items-start gap-6">
                            ...
                            <p className="text-lg text-justify leading-relaxed flex-1">
                                ...
                                the only landlocked region in the Philippines,
                                situated in the rugged mountain ranges of
                                north-central Luzon. Its strategic location in
                                the Cordillera mountains gives it a unique
                                geography characterized by high elevations,
                                rolling terrains, and river valleys. The region
                                is bordered on the north by the province of
                                Cagayan, on the east by Isabela and Nueva
                                Vizcaya, on the south by Pangasinan, and on the
                                west by La Union, Ilocos Sur, and Ilocos Norte.
                                This placement makes CAR a vital link between
                                the Cagayan Valley and the Ilocos Region.
                                Because of its mountainous terrain, it is home
                                to rich watersheds, vast forest reserves, and
                                scenic landscapes that play a significant role
                                in the country’s water and energy resources.
                            </p>
                    ...
                    <section className="mb-16">
                        ...
                        <p className="text-lg text-justify leading-relaxed">
                            ...
                            landlocked region in the Philippines, located in the
                            mountain ranges of the north central part of Luzon.
                    ...
                    <section className="mb-16">
                        ...
                        <p className="text-lg text-justify leading-relaxed">
                            Being dubbed as the "Watershed Cradle of the North",
                            the Cordillera has a mountainous topography
                            characterized by towering peaks, plateaus and
                            intermittent patches of valleys. About 80% of its
                            area is above 18% slope ranging from gently sloping
                    ...
                    <section className="mb-16">
                        ...
                        <p className="text-lg text-justify leading-relaxed">
                            ...
                            elevation terrain. It has over a hundred peaks, ten
                            of which are among the highest in the country. About
                            33% of the region’s table land lies 1,000 meters or
                            more above sea level; this is predominant in the
                            provinces of Benguet and Mt. Province. This
                            generally gives the cool temperate climate of these
                            provinces. Only 40% of its lowland areas are on
                            elevations less than 500 meters above sea level. It
                            has 239 large and small mountains which include Mt.
                            Pulag, the third highest in the country having an
                            elevation of 2,922 meters above sea level.
                        </p>
                        {/* Images Grid */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1 mt-8">
                            {[
                    ...
                    <section className="mb-16">
                        ...
                        <p className="text-lg text-justify leading-relaxed">
                            ...
                            region attributes its seismicity to the active
                            faults along the branches of the northern segments
                            of the Philippine Fault Zone such as the Digdig
                            Fault and the active subduction along the Manila
                            Trench. The devastating earthquake of July 1990 was
                            believed to have originated from the Digdig Fault.
                        </p>
                    </section>
                    ...
                    <section className="mb-16">
                        ...
                        <p className="text-lg text-justify leading-relaxed">
                            The region is known for its very cool climate which
                            is mainly due to its high mean elevation. It is
                            governed by two (2) climatic type where Type I (red)
                            covers about 64% and Type III (white) covers 33% of
                            the total area. Type I is characterized by two (2)
                            pronounced seasons: dry season from November to
                            April and wet season for the rest of the year.The
                            provinces that fall under this type are Benguet
                            including Baguio City; eastern part of Abra, Ifugao
                            and Mountain Province. Type III has no pronounced
                            maximum rain period with a short dry season lasting
