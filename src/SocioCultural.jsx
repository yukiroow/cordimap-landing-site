import { ChevronLeft, Users, TrendingUp, ComponentIcon, LibraryBig, Car, Podcast, PickaxeIcon, Binoculars, Phone, Mail, Facebook } from "lucide-react";
            ...
            <div className="min-h-screen ml-15 mr-15">
                ...
                <div className="flex flex-row w-full justify-center mb-8">
                    <div className="tabs tabs-box w-[80%]">
                        {/* Abra */}
                        <input type="radio" name="my_tabs_6" className="tab" aria-label="Abra" defaultChecked />
                        <div className="tab-content bg-base-100 border-base-300 p-6">
                            <div className="carousel w-full mx-auto rounded-lg shadow-md">
                                <div id="abra1" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\abra-river.JPG" alt="abra-river" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Abra River</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">The most popular river among the numerous rivers crisscrossing the valleys of the province,
                                ...
                                <div id="abra2" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\boliney-hot-spring.JPG" alt="boliney-hot-spring" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Boliney Hot Spring</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">Located at Bani, Boliney, Abra. It can be reached by jeepneys after travelling 32 kms. The place is an ideal for swimmers
                                ...
                                <div id="abra3" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\tugot-ni-angalo.JPG" alt="tugot-ni-angalo" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Tugot ni Angalo</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">Translated as "Footprints of Angalo", the Adam in Abra mythology- it is found in Kabaruyan, San Quintin. The "footprint" is a
                        ...
                        <div className="tab-content bg-base-100 border-base-300 p-6">
                            <div className="carousel w-full mx-auto rounded-lg shadow-md">
                                <div id="apayao1" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\marag-rock-formation.jpg" alt="marag-rock-formation" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Marag Rock Formation</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">Located at Marag Valley, Luna, Apayao. Visitors experience thrill of climbing the rock formations and the relaxing view of Luna’s nature
                                ...
                                <div id="apayao2" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\apayao-river.jpg" alt="apayao-river" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Apayao River</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">The river is the longest river of Apayao stretching a distance of 180 kilometers traversing through all of the province’s municipalities except Conner.
                        ...
                        <div className="tab-content bg-base-100 border-base-300 p-6">
                            <div className="carousel w-full mx-auto rounded-lg shadow-md">
                                <div id="benguet1" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\mt-pulag.jpg" alt="mt-pulag" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Mt. Pulag National Park</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">Second highest peak in the Philippines, next to Mt. Apo, towering at an altitude of 9,640 feet above sea level. It is home to many highland flora and
                                ...
                                <div id="benguet2" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\mt-ugo.jpg" alt="mt-ugo" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Mt. Ugo</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">Located at Tinongdan, Itogon, Benguet, a thriving tourist attraction for mountain climbing.</p>
                                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
                                ...
                                <div id="benguet3" className="carousel-item relative w-full flex flex-col items-center">
                                    ...
                                    <p className="text-sm text-center mb-4 px-[10%]">Located in Bokod, Benguet, it features hiking under Benguet Pine forests to mossy forests. It also offers
                        ...
                        <div className="tab-content bg-base-100 border-base-300 p-6">
                            <div className="carousel w-full mx-auto rounded-lg shadow-md">
                                <div id="ifugao1" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\banaue-rice-terraces.jpg" alt="banaue-rice-terraces" className="object-cover w-full h-[700px]" />
                                    <h2 className="text-lg font-semibold mt-2">Banaue Rice Terraces</h2>
                                    <p className="text-sm text-center mb-4 px-[10%]">Best seen at the viewpoint in Banaue, the rice terraces rise steeply from the base of the mountain range to a
                                ...
                                <div id="ifugao2" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\bangaan-rice-terraces.jpg" alt="bangaan-rice-terraces" className="object-cover w-full h-[700px]" />
                        ...
                        <div className="tab-content bg-base-100 border-base-300 p-6">
                            <div className="carousel w-full mx-auto rounded-lg shadow-md">
                                <div id="kalinga1" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\chico-river.jpg" alt="chico-river" className="object-cover w-full h-[700px]" />
                        ...
                        <div className="tab-content bg-base-100 border-base-300 p-6">
                            <div className="carousel w-full mx-auto rounded-lg shadow-md">
                                <div id="mtprovince1" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\mabarotbot-oil-seepage.jpg" alt="mabarotbot-oil-seepage" className="object-cover w-full h-[700px]" />
                                    ...
                                    <p className="text-sm text-center mb-4 px-[6%]">
                                        ...
                                        pools of mud caused by deposits of suspected methane gas.
                                ...
                                <div id="mtprovince2" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\natonin-and-apatan-rice-terraces.jpg" alt="natonin-and-apatan-rice-terraces" className="object-cover w-full h-[700px]" />
                        ...
                        <div className="tab-content bg-base-100 border-base-300 p-6">
                            <p className="text-sm text-center mb-4 px-[10%]">These tourist sites supplement the natural sites and serves as potential tourist destinations.
                            ...
                            <div className="carousel w-full mx-auto rounded-lg shadow-md">
                                <div id="manmade1" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\tangadan-tunnel.jpg" alt="tangadan-tunnel" className="object-cover w-full h-[700px]" />
                                ...
                                <div id="manmade2" className="carousel-item relative w-full flex flex-col items-center">
                                    <img src="src\assets\SCEP-Gallery\victoria-national-park.jpg" alt="victoria-national-park" className="object-cover w-full h-[700px]" />
