            ...
            >
                ...
                <Reveal delay={200}>
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-justify pb-4 sm:pb-6">
                        ...
                        Rice Terraces in the province of Ifugao is considered as
                        the "Eight Wonder of the World". This structure of about
                        2000 to 6000 years old is a United Nations Organization
                        for Education, Science and Culture (UNESCO) World
                        Heritage Site. Other tourist attractions of the region
                        include the Sumaguing Cave in Sagada and the mummy caves
                        in Benguet and Mt. Province. Mount Pulag Protected
                        Landscape is the highest mountain in Luzon.
                    </p>
                </Reveal>
            </section>
                        ...
                        <Reveal delay={80} className="flex-1">
                            <p className="text-base sm:text-lg md:text-xl text-justify">
                                <span className="text-lg sm:text-xl md:text-2xl font-semibold">
                                    Geographical Location, Land Area and
                                    Political Subdivision.
                                </span>
                                <br />
                                Cordillera Administrative Region is the only
                                landlocked region in the Philippines, located in
                                the mountain ranges of the north central part of
                                Luzon. It is bounded on the north by the
                                province of Cagayan, on the East by Isabela and
                                Nueva Viscaya, on the South by Pangasinan and on
                                the West by La Union, Ilocos Sur and Ilocos
                                Norte.
                            </p>
                        </Reveal>
                    ...
                    <Reveal delay={100}>
                        <div className="mt-6">
                            <p className="text-base sm:text-lg md:text-xl text-justify">
                                ...
                                resources. It is especially famed for its huge
                                gold deposits, pure stands of pine forest, and
                                rich soils and water sources that have enabled
                                its people to sustain agriculture on
                    ...
                    transition-transform duration-700"
                        >
                            ...
                            <p className="text-sm sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-justify">
                                ...
                                Apayao-Abulug River Basin, Abra River Basin and
                                ...
                                2 that serve as the major sources of water for
                            ...
                            >
                                ...
                                >
                                    <p className="text-base sm:text-lg leading-relaxed text-justify text-gray-800">
                                        ...
                                        such as{" "}
                                        <span className="text-blue-700 font-semibold">
                                            timber poaching and forest landuse
                                            conversion to agricultural use{" "}
                                        </span>
                                        among others, that are inimical to the
                                        pristine requirement for rich
                                        biodiversity and its sustainable
                                        existence. The abundance, distribution
                                        and degree of threat to which these
                                        resources are
                                        <span className="text-blue-700 font-semibold">
                                            {" "}
                                            exposed calls for a rapid and
                                            effective response{" "}
                                        </span>
                                        to accelerate the coverage of
