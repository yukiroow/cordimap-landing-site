        ...
        <div className="flex flex-col items-center justify-center space-y-6 pl-20 pr-15">
          ...
          <div className="flex flex-col w-full">
            ...
            <p className="text-xl text-justify">
              ...
              the Philippines, located in the mountain ranges of the north
              central part of Luzon. It is bounded on the north by the province
              of Cagayan, on the East by Isabela and Nueva Viscaya, on the South
              by Pangasinan and on the West by La Union, Ilocos Sur and Ilocos
              Norte.
            </p>
          ...
          <div className="flex flex-col items-center">
            <p className="flex text-xl text-justify">
              ...
              barangays that makes up to 6.6 percent of the total land area of
              the Philippines. The total area of the region of about 1,865,454
              hectares based on the approved cadastral boundary map. The
              Alienable and Disposable lands is 15.05% of the total land area
              while 84.95% is forestland. Mountain Province has the least area
              coverage with a total of 231,486 hectares. The chartered city of
              Baguio is less than 1% of the total area of the region.
            </p>
          ...
          >
            <div className="bg-green-800 bg-opacity-50 text-white w-[35rem] h-[25rem] p-8 rounded-lg shadow-xl mr-12 ml-40">
              ...
              <article>
                ...
                <p className="text-base leading-relaxed">
                  Table 8 categorizes the land in the region into uses following
                  a land classification system based on land use suitability
                  analysis.
                </p>
              </article>
            </div>
            ...
            <div className="absolute inset-0 z-10 flex items-center justify-center">
              <div className="max-w-3xl text-white px-12 py-8">
                ...
                <p className="text-lg leading-relaxed text-justify">
                  ...
                  watersheds, playing a key role in maintaining ecological
                  balance in Northern Philippines. Most of the major river
                  basins drain to Regions 1 and 2 that serves as the major
                  sources of water for domestic, agricultural, power generation
          ...
          <div className="flex flex-col pl-20 pr-15">
            ...
            <div className="space-y-3 text-lg text-justify">
              ...
              <p className="text-xl text-justify">
                ...
                on the Department of Finance, Department Order No. 23-08.
          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            ...
            <div className="text-center md:text-left space-y-2">
              <p className="text-lg font-semibold">
                DENR Compound, Gibraltar Rd, <br></br>Baguio, Benguet
              </p>
            </div>
            {/* Right: Directory */}
