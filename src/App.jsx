...
const App = () => {
    return (
        ...
        <section className="relative flex flex-col items-center justify-center w-full h-screen text-center text-gray-900 overflow-hidden">
            ...
            <img src="src/assets/Landing-page/igorot.png" alt="background" className="absolute right-0 bottom-0 w-1/2 object-contain -z-10"/>

            <div className="relative bottom-17 right-45">
                <h1 className="text-8xl pb-5 font-bold">One Cordillera</h1>
                <h2 className="text-5xl md:text-6xl pb-3 mt-2">A Glimpse of the <br /> Mountainous Region</h2>
                <p className="text-4xl mt-2">DENR - CAR <br/> 2025 </p>
        ...
        <section id="car" className="flex flex-col items-center justify-center  min-h-screen w-screen overflow-hidden m-0 p-0 pl-25 pr-25 bg-gradient-to-b from-[#3b82f640] to-white">
            ...
            <div className="flex flex-wrap gap-20 pb-20 justify-center">
                ...
                <img src="src/assets/Logos/Province-of-Kalinga-Logo.png" alt="Province of Kalinga Logo" className="w-45 h-45 rounded-lg" />
                <img src="src/assets/Logos/Mountain-Province-Logo.png" alt="Mountain Province Logo" className="w-45 h-45 rounded-lg" />
                <img src="src/assets/Logos/Province-of-Abra-Logo.png" alt="Province of Abra Logo" className="w-45 h-45 rounded-lg" />
                <img src="src/assets/Logos/Province-of-Apayao-Logo.png" alt="Province of Apayao Logo" className="w-45 h-45 rounded-lg" />
                <img src="src/assets/Logos/Province-of-Ifugao-Logo.png" alt="Province of Ifugao Logo" className="w-45 h-45 rounded-lg" />
        ...
        <div id="bio" className="flex flex-col items-center justify-center">
            ...
            >
                <h1 className="text-6xl font-bold text-white">BIOPHYSICAL PROFILE</h1>
            </div>
